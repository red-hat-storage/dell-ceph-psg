...
network  --bootproto=static --device=em3 --gateway=172.21.15.254 --ip=172.21.1.115 --nameserver=172.21.0.10 --netmask=255.255.240.0 --noipv6 --activate
...
network  --hostname=refarch-r730xd-03.front.sepia.ceph.com
